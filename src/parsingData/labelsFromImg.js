...
//The version that i copied from my comp
// Imports the Google Cloud client library
// const vision = require("@google-cloud/vision");
// const fs = require("fs");
// const fetch = require("node-fetch");
...
//   categoryLableArray = crossRefrence(categoryLableArray);
//   //we get the label array after checking their freq, and adding ID's
//   semanticsCategories = await upperCategoryOfLabels(categoryLableArray);
//   return categoryLableArray;
// }
